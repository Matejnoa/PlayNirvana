...
namespace NkCibalia.Views
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Position,Age")] Players players)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Position,Age")] Players players)
        {
            if (id != players.Id)
            {
                return NotFound();
